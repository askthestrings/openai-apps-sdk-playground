...
import "./Icon-DBAEOlH8.js";
import { t as clsx } from "./clsx-Lkrca6_3.js";
import "./dist-BxZK2fg8.js";
import "./helpers-B7tlCM9E.js";
import "./renderHelpers-Bcyyvrju.js";
import "./internal-Bdt7XhLm.js";
import "./Button-CRJOnNhF.js";
import { i as decodeNamedCharacterReference, n as CodeBlockBase, r as parseEntities, t as CodeBlock } from "./CodeBlock-Bl1pNwjr.js";
import { a as html$2, c as hastToReact, i as stringify, o as svg, r as stringify$1, s as find } from "./lib-BxDcLvMZ.js";
import { n as visitParents, r as convert } from "./lib-6LGEHtQ7.js";
import { _ as codes, a as asciiAtext, c as asciiHexDigit, d as markdownLineEndingOrSpace, f as markdownSpace, g as constants, h as types, i as asciiAlphanumeric, l as asciiPunctuation, m as unicodeWhitespace, n as factorySpace, o as asciiControl, p as unicodePunctuation, r as asciiAlpha, s as asciiDigit, t as longestStreak, u as markdownLineEnding, v as ok, y as unreachable } from "./longest-streak-C9lJEHmZ.js";
import { t as TextLink } from "./TextLink-BNjZ0vpj.js";
import s from "/Users/thestrings/Downloads/openai-apps-sdk-playground/node_modules/@openai/apps-sdk-ui/dist/es/components/Markdown/Markdown.module.css";
...
//#endregion
//#region node_modules/@openai/apps-sdk-ui/dist/es/lib/ids.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var createId = (prefix, maxLength = 21) => `${prefix}_${Math.random().toString(36).slice(2, 10)}`.slice(0, maxLength);
//#endregion
//#region node_modules/@openai/apps-sdk-ui/dist/es/lib/safeBase64.js
var toUrlBase64 = (bin) => btoa(bin).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "");
var fromUrlBase64 = (b64) => atob(b64.replace(/-/g, "+").replace(/_/g, "/"));
var encodeBase64 = (value) => {
	if (value === void 0) throw new TypeError("encodeBase64: `undefined` cannot be encoded to valid JSON. Pass null instead.");
...
//#endregion
//#region node_modules/@openai/apps-sdk-ui/dist/es/components/Markdown/directives.js
function createMarkdownDirective({ render, name, mode }) {
...
*   Tokenizer.
*/
function tokenizeContainer(effects, ok$48, nok) {
	ok(this.parser.constructs.disable.null, "expected `disable.null` to be populated");
	return factorySpace(effects, effects.attempt(this.parser.constructs.document, ok$48, nok), types.linePrefix, this.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize);
}
//#endregion
...
* @type {Tokenizer}
*/
function tokenizeAttention(effects, ok$47) {
...
* @type {Tokenizer}
*/
function tokenizeAutolink(effects, ok$46, nok) {
	let size = 0;
	return start;
	/**
...
* @type {Tokenizer}
*/
function tokenizeBlockQuoteStart(effects, ok$44, nok) {
	const self = this;
	return start;
	/**
...
* @type {Tokenizer}
*/
function tokenizeBlockQuoteContinuation(effects, ok$45, nok) {
	const self = this;
	return contStart;
	/**
	* Start of block quote continuation.
	...
	*/
	function contBefore(code) {
		return effects.attempt(blockQuote, ok$45, nok)(code);
	}
}
/** @type {Exiter} */
...
* @type {Tokenizer}
*/
function tokenizeCharacterEscape(effects, ok$43, nok) {
	return start;
	/**
...
* @type {Tokenizer}
*/
function tokenizeCharacterReference(effects, ok$42, nok) {
	const self = this;
	let size = 0;
	/** @type {number} */
	let max;
...
* @type {Tokenizer}
*/
function tokenizeCodeFenced(effects, ok$39, nok) {
	const self = this;
	/** @type {Construct} */
	const closeStart = {
		partial: true,
	...
	*/
	function infoBefore(code) {
		if (code === codes.eof || markdownLineEnding(code)) {
			...
			return self.interrupt ? ok$39(code) : effects.check(nonLazyContinuation, atNonLazyBreak, after)(code);
		}
	...
	* @type {Tokenizer}
	*/
	function tokenizeCloseStart(effects, ok$40, nok) {
		let size = 0;
		return startBefore;
		/**
		*
...
* @type {Tokenizer}
*/
function tokenizeNonLazyContinuation(effects, ok$41, nok) {
	const self = this;
	return start;
	/**
	*
	...
	*/
	function lineStart(code) {
		return self.parser.lazy[self.now().line] ? nok(code) : ok$41(code);
	}
}
//#endregion
...
* @type {Tokenizer}
*/
function tokenizeCodeIndented(effects, ok$38, nok) {
	const self = this;
	return start;
	/**
...
* @type {Tokenizer}
*/
function tokenizeCodeText(effects, ok$37, nok) {
	const self = this;
	let sizeOpen = 0;
	/** @type {number} */
	let size;
	...
	*/
	function start(code) {
		...
		ok(previous$2.call(self, self.previous), "expected correct previous");
...
* @type {Tokenizer}
*/
function tokenizeContent(effects, ok$35) {
	/** @type {Token | undefined} */
	let previous;
	return chunkStart;
	/**
...
* @type {Tokenizer}
*/
function tokenizeContinuation(effects, ok$36, nok) {
	const self = this;
	...
	*/
	function prefixed(code) {
		...
		ok(self.parser.constructs.disable.null, "expected `disable.null` to be populated");
		const tail = self.events[self.events.length - 1];
		if (!self.parser.constructs.disable.null.includes("codeIndented") && tail && tail[1].type === types.linePrefix && tail[2].sliceSerialize(tail[1], true).length >= constants.tabSize) return ok$36(code);
		return effects.interrupt(self.parser.constructs.flow, nok, ok$36)(code);
	}
}
//#endregion
...
*   Start state.
*/
function factoryLabel$1(effects, ok$34, nok, type, markerType, stringType) {
	const self = this;
	let size = 0;
	/** @type {boolean} */
	let seen;
...
* @type {Tokenizer}
*/
function tokenizeDefinition(effects, ok$33, nok) {
	const self = this;
	/** @type {string} */
	let identifier;
	return start;
	...
	*/
	function before(code) {
		ok(code === codes.leftSquareBracket, "expected `[`");
		return factoryLabel$1.call(self, effects, labelAfter, nok, types.definitionLabel, types.definitionLabelMarker, types.definitionLabelString)(code);
	}
	/**
	* After label.
	*
...
* @type {Tokenizer}
*/
function tokenizeHardBreakEscape(effects, ok$32, nok) {
	return start;
	/**
...
* @type {Tokenizer}
*/
function tokenizeHeadingAtx(effects, ok$31, nok) {
	let size = 0;
	return start;
	/**
...
* @type {Tokenizer}
*/
function tokenizeHtmlFlow(effects, ok$29, nok) {
	const self = this;
	/** @type {number} */
	let marker;
	/** @type {boolean} */
	...
	*/
	function open(code) {
		...
		if (code === codes.questionMark) {
			...
			return self.interrupt ? ok$29 : continuationDeclarationInside;
		}
		if (asciiAlpha(code)) {
			ok(code !== null);
			effects.consume(code);
	...
	*/
	function cdataOpenInside(code) {
		...
		if (code === value.charCodeAt(index++)) {
			effects.consume(code);
			if (index === value.length) return self.interrupt ? ok$29 : continuation;
			return cdataOpenInside;
		}
		return nok(code);
	}
	...
	function tagName(code) {
		if (code === codes.eof || code === codes.slash || code === codes.greaterThan || markdownLineEndingOrSpace(code)) {
			...
			if (!slash && !closingTag && htmlRawNames.includes(name)) {
				...
				return self.interrupt ? ok$29(code) : continuation(code);
			}
	...
	*/
	function basicSelfClosing(code) {
		if (code === codes.greaterThan) {
			effects.consume(code);
			return self.interrupt ? ok$29 : continuation;
		}
		return nok(code);
	}
	/**
...
* @type {Tokenizer}
*/
function tokenizeBlankLineBefore(effects, ok$30, nok) {
	return start;
	/**
	...
	*/
	function start(code) {
		...
		effects.consume(code);
		effects.exit(types.lineEnding);
		return effects.attempt(blankLine, ok$30, nok);
	}
}
//#endregion
...
* @type {Tokenizer}
*/
function tokenizeHtmlText(effects, ok$28, nok) {
	const self = this;
...
* @type {Tokenizer}
*/
function tokenizeLabelEnd(effects, ok$24, nok) {
	const self = this;
...
* @type {Tokenizer}
*/
function tokenizeResource(effects, ok$25, nok) {
...
* @type {Tokenizer}
*/
function tokenizeReferenceFull(effects, ok$26, nok) {
	const self = this;
	...
	*/
	function referenceFull(code) {
		...
		return factoryLabel$1.call(self, effects, referenceFullAfter, referenceFullMissing, types.reference, types.referenceMarker, types.referenceString)(code);
	}
	/**
	...
	*/
	function referenceFullAfter(code) {
		return self.parser.defined.includes(normalizeIdentifier(self.sliceSerialize(self.events[self.events.length - 1][1]).slice(1, -1))) ? ok$26(code) : nok(code);
	}
	/**
...
* @type {Tokenizer}
*/
function tokenizeReferenceCollapsed(effects, ok$27, nok) {
...
* @type {Tokenizer}
*/
function tokenizeLabelStartImage(effects, ok$23, nok) {
	const self = this;
	return start;
	/**
	...
	*/
	function after(code) {
		/* c8 ignore next 3 */
		return code === codes.caret && "_hiddenFootnoteSupport" in self.parser.constructs ? nok(code) : ok$23(code);
	}
}
//#endregion
...
* @type {Tokenizer}
*/
function tokenizeLabelStartLink(effects, ok$22, nok) {
	const self = this;
	return start;
	/**
	...
	*/
	...
	function after(code) {
		/* c8 ignore next 3 */
		return code === codes.caret && "_hiddenFootnoteSupport" in self.parser.constructs ? nok(code) : ok$22(code);
	}
}
//#endregion
...
* @type {Tokenizer}
*/
function tokenizeLineEnding(effects, ok$21) {
	return start;
	/** @type {State} */
	function start(code) {
		ok(markdownLineEnding(code), "expected eol");
		...
		effects.consume(code);
		effects.exit(types.lineEnding);
		return factorySpace(effects, ok$21, types.linePrefix);
	}
}
//#endregion
...
* @type {Tokenizer}
*/
function tokenizeThematicBreak(effects, ok$20, nok) {
	let size = 0;
	/** @type {NonNullable<Code>} */
	let marker;
	return start;
...
* @type {Tokenizer}
*/
function tokenizeListStart(effects, ok$16, nok) {
	const self = this;
	const tail = self.events[self.events.length - 1];
	...
	function start(code) {
		...
		if (kind === types.listUnordered ? !self.containerState.marker || code === self.containerState.marker : asciiDigit(code)) {
			...
			if (kind === types.listUnordered) {
				...
				return code === codes.asterisk || code === codes.dash ? effects.check(thematicBreak$2, nok, atMarker)(code) : atMarker(code);
			}
...
* @type {Tokenizer}
*/
function tokenizeListContinuation(effects, ok$17, nok) {
	const self = this;
	ok(self.containerState, "expected state");
	self.containerState._closeFlow = void 0;
	...
	function onBlank(code) {
		...
		return factorySpace(effects, ok$17, types.listItemIndent, self.containerState.size + 1)(code);
	}
	/** @type {State} */
	function notBlank(code) {
		...
		self.containerState.furtherBlankLines = void 0;
		self.containerState.initialBlankLine = void 0;
		return effects.attempt(indentConstruct, ok$17, notInCurrentItem)(code);
	}
	/** @type {State} */
	function notInCurrentItem(code) {
		...
		self.interrupt = void 0;
		ok(self.parser.constructs.disable.null, "expected `disable.null` to be populated");
		return factorySpace(effects, effects.attempt(list$2, ok$17, nok), types.linePrefix, self.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize)(code);
	}
}
/**
* @this {TokenizeContext}
...
* @type {Tokenizer}
*/
function tokenizeIndent$1(effects, ok$18, nok) {
	const self = this;
	ok(self.containerState, "expected state");
	ok(typeof self.containerState.size === "number", "expected size");
	...
	function afterPrefix(code) {
		ok(self.containerState, "expected state");
		const tail = self.events[self.events.length - 1];
		return tail && tail[1].type === types.listItemIndent && tail[2].sliceSerialize(tail[1], true).length === self.containerState.size ? ok$18(code) : nok(code);
	}
}
/**
* @this {TokenizeContext}
...
* @type {Tokenizer}
*/
function tokenizeListItemPrefixWhitespace(effects, ok$19, nok) {
	const self = this;
	ok(self.parser.constructs.disable.null, "expected `disable.null` to be populated");
	...
	function afterPrefix(code) {
		const tail = self.events[self.events.length - 1];
		return !markdownSpace(code) && tail && tail[1].type === types.listItemPrefixWhitespace ? ok$19(code) : nok(code);
	}
}
//#endregion
...
* @type {Tokenizer}
*/
function tokenizeSetextUnderline(effects, ok$15, nok) {
	const self = this;
	/** @type {NonNullable<Code>} */
	let marker;
	return start;
			...
			*/
			function handleConstruct(construct) {
				...
				function start(code) {
					...
					return construct.tokenize.call(fields ? Object.assign(Object.create(context), fields) : context, effects, ok$14, nok)(code);
				}
			}
			/** @type {State} */
			function ok$14(code) {
...
function directiveToMarkdown(options) {
	...
	if (settings.quote !== "\"" && settings.quote !== "'" && settings.quote !== null && settings.quote !== void 0) throw new Error("Invalid quote `" + settings.quote + "`, expected `'` or `\"`");
	...
	*/
	function handleDirective(node, _, state, info) {
		...
		if (label && label.children && label.children.length > 0) {
			...
			value += tracker.move("[");
			value += tracker.move(state.containerPhrasing(label, {
				...tracker.current(),
				before: value,
				after: "]"
			}));
		...
		if (node.type === "containerDirective") {
			const head = (node.children || [])[0];
			let shallow = node;
			if (inlineDirectiveLabel(head)) shallow = Object.assign({}, node, { children: node.children.slice(1) });
	...
	*/
	function attributes(node, state) {
		...
		/** @type {string} */
		let key;
		for (key in attributes) if (own.call(attributes, key) && attributes[key] !== void 0 && attributes[key] !== null) {
			const value = String(attributes[key]);
			if (key === "id") id = settings.preferShortcut !== false && shortcut.test(value) ? "#" + value : quoted("id", value, node, state);
			else if (key === "class") {
				...
				const classesList = [];
				let index = -1;
				while (++index < list.length) (settings.preferShortcut !== false && shortcut.test(list[index]) ? classesList : classesFullList).push(list[index]);
				classesFull = classesFullList.length > 0 ? quoted("class", classesFullList.join(" "), node, state) : "";
				classes = classesList.length > 0 ? "." + classesList.join(".") : "";
			} else values.push(quoted(key, value, node, state));
		}
		if (classesFull) values.unshift(classesFull);
		if (classes) values.unshift(classes);
		if (id) values.unshift(id);
	...
	*/
	function quoted(key, value, node, state) {
		...
		if (settings.preferUnquoted && unquoted.test(value)) return key + "=" + value;
		...
		const subset = node.type === "textDirective" ? [appliedQuote] : [
			appliedQuote,
			"\n",
			"\r"
		];
...
function exitName(token) {
	const node = this.stack[this.stack.length - 1];
	ok(node.type === "containerDirective" || node.type === "leafDirective" || node.type === "textDirective");
	...
	if (node.type === "containerDirective") {
		visitParents(node, function(node, parents) {
			if (node.type === "containerDirective") {
				...
				let nesting = 0;
				while (index--) if (parents[index].type === "containerDirective") nesting++;
				if (nesting > size) size = nesting;
			}
		});
		size += 3;
	} else if (node.type === "leafDirective") size = 2;
	else size = 1;
	return ":".repeat(size);
}
//#endregion
//#region node_modules/micromark-extension-directive/dev/lib/factory-attributes.js
/**
...
*/
function factoryAttributes(effects, ok$13, nok, attributesType, attributesMarkerType, attributeType, attributeIdType, attributeClassType, attributeNameType, attributeInitializerType, attributeValueLiteralType, attributeValueType, attributeValueMarker, attributeValueData, disallowEol) {
	/** @type {TokenType} */
	let type;
	/** @type {Code | undefined} */
	let marker;
	...
	function between(code) {
		...
		if (disallowEol && markdownSpace(code)) return factorySpace(effects, between, types.whitespace)(code);
		if (!disallowEol && markdownLineEndingOrSpace(code)) return factoryWhitespace(effects, between)(code);
		return end(code);
	}
	/** @type {State} */
	...
	function shortcutStartAfter(code) {
		if (code === codes.eof || code === codes.quotationMark || code === codes.numberSign || code === codes.apostrophe || code === codes.dot || code === codes.lessThan || code === codes.equalsTo || code === codes.greaterThan || code === codes.graveAccent || code === codes.rightCurlyBrace || markdownLineEndingOrSpace(code)) return nok(code);
	...
	function shortcut(code) {
		if (code === codes.eof || code === codes.quotationMark || code === codes.apostrophe || code === codes.lessThan || code === codes.equalsTo || code === codes.greaterThan || code === codes.graveAccent) return nok(code);
	...
	function name(code) {
		...
		if (disallowEol && markdownSpace(code)) return factorySpace(effects, nameAfter, types.whitespace)(code);
		if (!disallowEol && markdownLineEndingOrSpace(code)) return factoryWhitespace(effects, nameAfter)(code);
	...
	function valueBefore(code) {
		if (code === codes.eof || code === codes.lessThan || code === codes.equalsTo || code === codes.greaterThan || code === codes.graveAccent || code === codes.rightCurlyBrace || disallowEol && markdownLineEnding(code)) return nok(code);
		if (code === codes.quotationMark || code === codes.apostrophe) {
		...
		if (disallowEol && markdownSpace(code)) return factorySpace(effects, valueBefore, types.whitespace)(code);
		if (!disallowEol && markdownLineEndingOrSpace(code)) return factoryWhitespace(effects, valueBefore)(code);
	...
	function valueQuotedBetween(code) {
		...
		if (code === codes.eof) return nok(code);
		if (markdownLineEnding(code)) return disallowEol ? nok(code) : factoryWhitespace(effects, valueQuotedBetween)(code);
		effects.enter(attributeValueData);
		effects.consume(code);
		return valueQuoted;
	}
...
//#endregion
//#region node_modules/micromark-extension-directive/dev/lib/factory-label.js
/**
...
* @param {boolean | undefined} [disallowEol=false]
*/
function factoryLabel(effects, ok$12, nok, type, markerType, stringType, disallowEol) {
	let size = 0;
	let balance = 0;
	/** @type {Token | undefined} */
	let previous;
	...
	/** @type {State} */
	function lineStart(code) {
		if (code === codes.rightSquareBracket && !balance) return atClosingBrace(code);
		const token = effects.enter(types.chunkText, {
			contentType: constants.contentTypeText,
			previous
		});
	...
	/** @type {State} */
	function data(code) {
		if (code === codes.eof || size > constants.linkReferenceSizeMax) return nok(code);
		if (code === codes.leftSquareBracket && ++balance > constants.linkResourceDestinationBalanceMax) return nok(code);
		if (code === codes.rightSquareBracket && !balance--) {
			effects.exit(types.chunkText);
			return atClosingBrace(code);
		}
		if (markdownLineEnding(code)) {
			if (disallowEol) return nok(code);
			effects.consume(code);
			effects.exit(types.chunkText);
			return lineStart;
		}
...
//#endregion
//#region node_modules/micromark-extension-directive/dev/lib/factory-name.js
/**
...
//#endregion
//#region node_modules/micromark-extension-directive/dev/lib/directive-container.js
/**
...
* @type {Tokenizer}
*/
function tokenizeDirectiveContainer(effects, ok$9, nok) {
	const self = this;
	const tail = self.events[self.events.length - 1];
	...
	function afterName(code) {
		return code === codes.leftSquareBracket ? effects.attempt(label$2, afterLabel, afterLabel)(code) : afterLabel(code);
	}
	/** @type {State} */
	function afterLabel(code) {
		return code === codes.leftCurlyBrace ? effects.attempt(attributes$2, afterAttributes, afterAttributes)(code) : afterAttributes(code);
	}
	/** @type {State} */
	...
	function openAfter(code) {
		...
		if (code === codes.eof) return after(code);
		if (markdownLineEnding(code)) {
			if (self.interrupt) return ok$9(code);
	...
	function contentStart(code) {
		if (code === codes.eof) return after(code);
		if (markdownLineEnding(code)) return effects.check(nonLazyLine, emptyContentNonLazyLineAfter, after)(code);
	...
	function lineStart(code) {
		return effects.attempt({
			...
			partial: true
		}, afterContent, initialSize ? factorySpace(effects, chunkStart, types.linePrefix, initialSize + 1) : chunkStart)(code);
	}
	/** @type {State} */
	function chunkStart(code) {
		if (code === codes.eof) return afterContent(code);
		if (markdownLineEnding(code)) return effects.check(nonLazyLine, chunkNonLazyStart, afterContent)(code);
	...
	function contentContinue(code) {
		...
		if (markdownLineEnding(code)) return effects.check(nonLazyLine, nonLazyLineAfter, lineAfter)(code);
		effects.consume(code);
	...
	* @type {Tokenizer}
	*/
	function tokenizeClosingFence(effects, ok$10, nok) {
		let size = 0;
		ok(self.parser.constructs.disable.null, "expected `disable.null`");
		return factorySpace(effects, closingPrefixAfter, types.linePrefix, self.parser.constructs.disable.null.includes("codeIndented") ? void 0 : constants.tabSize);
		/** @type {State} */
...
* @type {Tokenizer}
*/
function tokenizeNonLazyLine(effects, ok$11, nok) {
	const self = this;
	return start;
	/** @type {State} */
	function start(code) {
	...
	/** @type {State} */
	function lineStart(code) {
		return self.parser.lazy[self.now().line] ? nok(code) : ok$11(code);
	}
}
//#endregion
//#region node_modules/micromark-extension-directive/dev/lib/directive-leaf.js
/**
...
* @type {Tokenizer}
*/
function tokenizeDirectiveLeaf(effects, ok$8, nok) {
	const self = this;
	return start;
	/** @type {State} */
	function start(code) {
	...
	/** @type {State} */
	function afterName(code) {
		return code === codes.leftSquareBracket ? effects.attempt(label$1, afterLabel, afterLabel)(code) : afterLabel(code);
	}
	/** @type {State} */
	function afterLabel(code) {
		return code === codes.leftCurlyBrace ? effects.attempt(attributes$1, afterAttributes, afterAttributes)(code) : afterAttributes(code);
	}
	/** @type {State} */
	function afterAttributes(code) {
...
//#endregion
//#region node_modules/micromark-extension-directive/dev/lib/directive-text.js
/**
...
* @type {Tokenizer}
*/
function tokenizeDirectiveText(effects, ok$7, nok) {
	const self = this;
	return start;
	/** @type {State} */
	function start(code) {
		ok(code === codes.colon, "expected `:`");
		ok(previous$1.call(self, self.previous), "expected correct previous");
	...
	/** @type {State} */
	function afterName(code) {
		return code === codes.colon ? nok(code) : code === codes.leftSquareBracket ? effects.attempt(label, afterLabel, afterLabel)(code) : afterLabel(code);
	}
	/** @type {State} */
	function afterLabel(code) {
...
//#endregion
//#region node_modules/micromark-extension-directive/dev/lib/syntax.js
/**
* @import {Extension} from 'micromark-util-types'
*/
/**
...
//#endregion
//#region node_modules/remark-directive/lib/index.js
/**
...
//#endregion
//#region node_modules/@openai/apps-sdk-ui/dist/es/components/Markdown/urlTransform.js
var defaultUrlTransform = (url) => {
	if (url.startsWith("tel:") || url.startsWith("sms:")) return url;
	return defaultUrlTransform$1(url);
};
//#endregion
//#region node_modules/@openai/apps-sdk-ui/dist/es/components/Markdown/useMathPlugins.js
var DEFAULT_EMPTY_STATE = {
	remarkPlugins: [],
	rehypePlugins: []
};
var resolvedPluginsCache = null;
var pluginLoadPromise = null;
async function loadMathDeps() {
	...
	pluginLoadPromise = (async () => {
		const [{ default: remarkMath }, { default: rehypeKatex }] = await Promise.all([import("./remark-math-D6dfgBlP.js"), import("./rehype-katex-648m8i-j.js")]);
...
function useMathPlugins(enabled) {
	const [ready, setReady] = (0, import_react.useState)(!!resolvedPluginsCache);
...
//#endregion
//#region node_modules/@openai/apps-sdk-ui/dist/es/components/Markdown/useParseMarkdownPre.js
function useParseMarkdownPre(children) {
	if (!children || typeof children !== "object" || !("props" in children) || typeof children.props !== "object" || !children.props) return {
		code: "",
		language: "text"
	};
	return {
		code: "children" in children.props && typeof children.props.children === "string" ? children.props.children.replaceAll(/\n$/g, "") : "",
		language: "className" in children.props && typeof children.props.className === "string" ? children.props.className.match(/language-(.*)$/)?.[1] ?? "text" : "text"
	};
}
//#endregion
//#region node_modules/@openai/apps-sdk-ui/dist/es/components/Markdown/Markdown.js
var supportsLookbehind = (() => {
	try {
		return true;
	} catch {
		return false;
...
function Markdown({ children, directives, includeMath = false, breakNewLines = false, components: propsComponents, remarkPlugins, rehypePlugins, allowedElements, disallowedElements, skipHtml, urlTransform = defaultUrlTransform, className, copyableCodeBlocks = true }) {
	...
	const mergedRemarkPlugins = (0, import_react.useMemo)(() => {
		...
		if (breakNewLines) baseRemarkPlugins.push(remarkBreaks);
		if (supportsLookbehind) baseRemarkPlugins.push([remarkGfm, { singleTilde: false }]);
	...
	return (0, import_jsx_runtime.jsx)(Markdown$1, {
...
var Pre = ({ children, className }) => {
	const { code, language } = useParseMarkdownPre(children);
	return (0, import_jsx_runtime.jsx)(CodeBlock, {
		language,
		className,
		children: code
	});
};
var InlineCode = ({ children, className }) => (0, import_jsx_runtime.jsx)("code", {
	className: clsx(s.InlineCode, className),
	children
});
var Anchor = ({ children, node: _node, ...props }) => (0, import_jsx_runtime.jsx)(TextLink, {
	as: "a",
	...props,
	children
});
var TableCell = ({ node: _node, children, ...rest }) => {
	return (0, import_jsx_runtime.jsx)("td", {
		...rest,
		children: import_react.Children.map(children, (child, i) => child === "<br>" ? (0, import_jsx_runtime.jsx)("br", {}, i) : child)
	});
};
...
var NonCopyableCodeBlock = ({ children, className }) => {
	const { code, language } = useParseMarkdownPre(children);
	return (0, import_jsx_runtime.jsx)(CodeBlockBase, {
		className,
		children: (0, import_jsx_runtime.jsx)(CodeBlockBase.Code, {
			language,
			children: code
		})
	});
};
var NON_COPYABLE_CODE_BLOCK_COMPONENTS = { pre: NonCopyableCodeBlock };
//#endregion
export { Markdown, createMarkdownDirective, defaultUrlTransform, useParseMarkdownPre };

//# sourceMappingURL=@openai_apps-sdk-ui_components_Markdown.js.map